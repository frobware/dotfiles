...
update-oh-my-bsh:
	curl -s -L -o oh-my-bsh-master.tar.gz https://github.com/ohmybash/oh-my-bash/archive/master.tar.gz
	chezmoi import --strip-components 1 --destination ${HOME}/.oh-my-bsh oh-my-bsh-master.tar.gz
